package com.deposit.D2E2EMobileFramework.D2E2ESparkMobileFramework.Utilities;
...
public class TestResultsUtils {
	 ...
	 */
	public static void outputFolder() throws D2E2ESparkMobileFrameworkException {
		try {
			...
			if (null == executionStartDate) {
				...
				if (null != baseDirectory) {
					browserDirectory = baseDirectory.concat(Constants.DOUBLE_FORWARD_SLASH)
							.concat(AppiumNGSuite.browserType);
...
/*	public String takescreenshot(String scenario) throws Exception {
	...
	screenshotPath = TestResultsUtils.screenshotDirectory + "/sc-" + scenario + startedAt + ".png";			return screenshotPath;
		} catch (Exception exception) {
...
throw new D2E2ESparkMobileFrameworkException(exception);
	...
	public static void extentReportInitialize() throws D2E2ESparkMobileFrameworkException {
		try {
	...
	public static void extentReportFlush() throws D2E2ESparkMobileFrameworkException {
		try {
